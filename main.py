                                    ...
                                    with st.form("create_user_form_refactored", clear_on_submit=True):
                                        ...
                                        with col2:
                                            ...
                                            default_selection_for_display = [
                                                role for role in current_selected_roles_from_state if
                                        ...
                                        if edited_user:
                                            ...
                                            with st.form(key=f"edit_user_form_{edited_user['id']}",
                                                ...
                                                default_edit_selection_for_display = [
                                                    role for role in current_edited_roles if
                                                    role != instructional_roles_text
                                                ]
                            ...
                            with tab_overview_list:
                                ...
                                with col_filters2:
                                    ...
                                    date_start_default = st.session_state.dashboard_filter_date_start or (
                                        df_notifications[
                                            'created_at_dt'].min().date() if not df_notifications.empty else date.today() - timedelta(
                                            days=365)
                                    )
                                    date_end_default = st.session_state.dashboard_filter_date_end or (
                                        df_notifications[
                                            'created_at_dt'].max().date() if not df_notifications.empty else date.today()
                                    )
